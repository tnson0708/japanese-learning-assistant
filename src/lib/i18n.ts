...
export const translations = {
  en: {
    ...
    vocab_print_btn: "Print Cutout Labels (A4)",
    vocab_print_modal_title: "Print Vocabulary Cutout Tags",
    vocab_print_modal_desc: "Print these cards onto A4 paper, cut along the dashed lines ✂️, and tape them onto real objects (laptop, desk, book, monitor, etc.) to memorize faster!",
    vocab_print_btn_confirm: "Print Labels Now",
    vocab_print_count: "tags to print",
  ...
  vi: {
    ...
    vocab_print_btn: "In nhãn dán từ vựng (Khổ A4)",
    vocab_print_modal_title: "In nhãn từ vựng dán đồ vật",
    vocab_print_modal_desc: "In các nhãn này ra giấy A4, dùng kéo cắt theo đường nét đứt ✂️ và dán lên các đồ vật thực tế (máy tính, bàn, sách, màn hình, v.v.) để học từ vựng nhanh nhớ!",
    vocab_print_btn_confirm: "Bắt đầu in ra giấy",
    vocab_print_count: "nhãn từ vựng",
