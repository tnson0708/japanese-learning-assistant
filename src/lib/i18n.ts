...
export const translations = {
  en: {
    ...
    hl_vocab_title: "Vocabulary by Life Domain",
    hl_vocab_desc:
      "Curated words grouped into domains and subtopics, filterable by JLPT level and word type.",
    ...
    kana_tab_kanji: "Kanji Radicals (漢字部首)",
    kana_script: "Script",
    ...
    paper_preset_title: "Drill Speed Preset",
    paper_preset_fast: "Fast (3s / 2s)",
    paper_preset_standard: "Standard (5s / 3s)",
    paper_preset_relaxed: "Relaxed (8s / 5s)",
    paper_preset_manual: "Manual (No timer)",
    paper_speed_option_fast: "⚡ Fast",
    paper_speed_option_standard: "⚖️ Normal",
    paper_speed_option_relaxed: "🐢 Relax",
    paper_speed_option_slow: "⏳ Slow",
    paper_speed_option_manual: "🖐️ Manual",
    paper_prompt_time: "Display Time (Prompt)",
    paper_reveal_time: "Check Time (Answer)",
    paper_speed_manual_desc: "Manual mode: Timers disabled. Click 'Reveal' & 'Next' when ready.",
    ...
    vocab_subtitle:
      "Browse curated vocabulary by life domain, then drill down into focused subtopics.",
    vocab_continue_learning: "Continue Learning",
    vocab_all_caught_up: "All caught up! 🎉",
    vocab_filter_level: "JLPT Level",
    vocab_filter_type: "Word Type",
    vocab_filter_all_levels: "All levels",
    vocab_filter_all_types: "All types",
    vocab_type_kanji: "Kanji",
    vocab_type_hiragana: "Hiragana",
    vocab_type_katakana: "Katakana",
    vocab_subtopics_count: "subtopics",
    vocab_words_count: "words",
    vocab_back_to_domains: "All domains",
    vocab_no_matching_subtopics: "No subtopics match the selected filters.",
    vocab_no_matching_domain: "No matches in this domain",
    vocab_words_learned: "words learned",
    vocab_mark_learned: "Mark as learned",
    vocab_marked_learned: "Learned",
    vocab_example_label: "Example",
    vocab_listen_sentence: "Listen to example sentence",
    vocab_quiz_entry: "🎯 Guess the English Word",
    vocab_quiz_prompt: "What English word does this come from?",
    vocab_quiz_reveal: "Reveal Answer",
    vocab_quiz_revealed: "Answer Revealed",
    vocab_quiz_hide: "Hide Answer",
    vocab_quiz_exit: "Exit Quiz",
    vocab_quiz_no_katakana: "This subtopic has no katakana words to quiz.",
    vocab_breadcrumb_vocabulary: "Vocabulary",
    vocab_print_btn: "Print Labels (A4)",
    vocab_print_instructions: "Cut along the dashed lines ✂️ and tape them onto real objects (kitchen items, furniture, desk, etc.) to memorize faster!",
    theory_print_btn: "Print Exercise Worksheet (A4)",
    theory_worksheet_title: "Japanese Language Exercise Worksheet",
    theory_student_name: "Name: ........................................... Date: ...../...../20.....",
  ...
  vi: {
    ...
    hl_vocab_title: "Từ vựng theo lĩnh vực",
    hl_vocab_desc:
      "Từ vựng chọn lọc theo lĩnh vực và chủ đề nhỏ, lọc được theo trình độ JLPT và loại từ.",
    ...
    kana_tab_kanji: "Bộ thủ Kanji (漢字部首)",
    ...
    paper_preset_title: "Tốc độ luyện tập",
    paper_preset_fast: "Nhanh (3s / 2s)",
    paper_preset_standard: "Tiêu chuẩn (5s / 3s)",
    paper_preset_relaxed: "Thong thả (8s / 5s)",
    paper_preset_manual: "Thủ công (Không đếm giờ)",
    paper_speed_option_fast: "⚡ Nhanh",
    paper_speed_option_standard: "⚖️ Bình thường",
    paper_speed_option_relaxed: "🐢 Thong thả",
    paper_speed_option_slow: "⏳ Chậm",
    paper_speed_option_manual: "🖐️ Thủ công",
    paper_prompt_time: "Thời gian hiện đề (Viết)",
    paper_reveal_time: "Thời gian kiểm tra (Đáp án)",
    paper_speed_manual_desc: "Chế độ thủ công: Không giới hạn thời gian. Bấm 'Hiện đáp án' & 'Tiếp theo' khi sẵn sàng.",
    ...
    vocab_title: "Từ vựng",
    vocab_subtitle:
      "Duyệt từ vựng theo từng lĩnh vực trong đời sống, sau đó đi sâu vào các chủ đề nhỏ tập trung.",
    vocab_continue_learning: "Tiếp tục học",
    vocab_all_caught_up: "Bạn đã học hết rồi! 🎉",
    vocab_filter_level: "Trình độ JLPT",
    vocab_filter_type: "Loại từ",
    vocab_filter_all_levels: "Tất cả trình độ",
    vocab_filter_all_types: "Tất cả loại từ",
    vocab_type_kanji: "Kanji",
    vocab_type_hiragana: "Hiragana",
    vocab_type_katakana: "Katakana",
    vocab_subtopics_count: "chủ đề nhỏ",
    vocab_words_count: "từ",
    vocab_back_to_domains: "Tất cả lĩnh vực",
    vocab_no_matching_subtopics: "Không có chủ đề nhỏ nào phù hợp với bộ lọc.",
    vocab_no_matching_domain: "Không có từ phù hợp trong lĩnh vực này",
    vocab_words_learned: "từ đã học",
    vocab_mark_learned: "Đánh dấu đã học",
    vocab_marked_learned: "Đã học",
    vocab_example_label: "Ví dụ",
    vocab_listen_sentence: "Nghe câu ví dụ",
    vocab_quiz_entry: "🎯 Đoán từ tiếng Anh gốc",
    vocab_quiz_prompt: "Từ này bắt nguồn từ từ tiếng Anh nào?",
    vocab_quiz_reveal: "Xem đáp án",
    vocab_quiz_revealed: "Đã hiện đáp án",
    vocab_quiz_hide: "Ẩn đáp án",
    vocab_quiz_exit: "Thoát",
    vocab_quiz_no_katakana: "Chủ đề này không có từ katakana để đố.",
    vocab_breadcrumb_vocabulary: "Từ vựng",
    vocab_print_btn: "In nhãn từ vựng (Khổ A4)",
    vocab_print_instructions: "Dùng kéo cắt theo đường nét đứt ✂️ và dán lên đồ vật thực tế (đồ bếp, nội thất, bàn học, v.v.) để học từ vựng nhanh thuộc hơn!",
    theory_print_btn: "In phiếu bài tập (Khổ A4)",
    theory_worksheet_title: "Phiếu Bài Tập Tiếng Nhật",
    theory_student_name: "Họ và tên: ........................................... Ngày: ...../...../20.....",
