...
interface BasicKanjiHandwritingCanvasProps {
  kanji: BasicKanjiWord;
  className?: string;
}

export function BasicKanjiHandwritingCanvas({
  kanji,
  className,
}: BasicKanjiHandwritingCanvasProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className={`relative ${className}`}>
        {/* Background Guide Character Overlay */}
