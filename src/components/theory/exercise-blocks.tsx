...
/**
 * Lists the textbook's listening-comprehension audio tracks for a lesson
 * (e.g. 問題 1-4 / Mondai 1-4), each independently playable.
 */
export function ListeningAudioListBlock({
  title,
  instruction,
  items,
}: {
