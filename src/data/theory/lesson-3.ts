  ...
  sections: [
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            { jp: "ジャカルタ", meaning: "Jakarta" },
            { jp: "バンコク", meaning: "Bangkok" },
            { jp: "ベルリン", meaning: "Berlin" },
    ...
    },
    {
      ...
      blocks: [
        {
          type: "table",
          title: "数字の読み方 (百・千) — Cách đọc hàng Trăm và hàng Nghìn",
          columns: ["Số đếm", "Tiếng Nhật (Kanji / Hiragana)", "Romaji", "Lưu ý biến âm"],
          speakableColumns: [1],
          rows: [
            ["100", "100 (ひゃく)", "hyaku", "Đọc bình thường"],
            ["200", "200 (にひゃく)", "nihyaku", "Đọc bình thường"],
            ["300", "300 (さんびゃく)", "sanbyaku", "Biến âm đục 濁音 (sanbyaku)"],
            ["400", "400 (よんひゃく)", "yonhyaku", "Đọc bình thường"],
            ["500", "500 (ごひゃく)", "gohyaku", "Đọc bình thường"],
            ["600", "600 (ろっぴゃく)", "roppyaku", "Biến âm bán đục 促音 (roppyaku)"],
            ["700", "700 (ななひゃく)", "nanahyaku", "Đọc bình thường"],
            ["800", "800 (はっぴゃく)", "happyaku", "Biến âm bán đục 促音 (happyaku)"],
            ["900", "900 (きゅうひゃく)", "kyūhyaku", "Đọc bình thường"],
            ["1,000", "1,000 (せん)", "sen", "Đọc bình thường (せん hoặc いっせん)"],
            ["2,000", "2,000 (にせん)", "nisen", "Đọc bình thường"],
            ["3,000", "3,000 (さんぜん)", "sanzen", "Biến âm đục 濁音 (sanzen)"],
            ["4,000", "4,000 (よんせん)", "yonsen", "Đọc bình thường"],
            ["5,000", "5,000 (ごせん)", "gosen", "Đọc bình thường"],
            ["6,000", "6,000 (ろくせん)", "rokusen", "Đọc bình thường"],
            ["7,000", "7,000 (ななせん)", "nanasen", "Đọc bình thường"],
            ["8,000", "8,000 (はっせん)", "hassen", "Biến âm 促音 (hassen)"],
            ["9,000", "9,000 (きゅうせん)", "kyūsen", "Đọc bình thường"],
          ],
        },
        {
          type: "table",
          title: "数字の読み方 (万・億) — Cách đọc hàng Vạn, hàng Triệu và Ức",
          columns: ["Con số", "Tiếng Nhật (Kanji / Hiragana)", "Romaji", "Đơn vị quy đổi"],
          speakableColumns: [1],
          rows: [
            ["10,000", "1万 (いちまん)", "ichiman", "1 vạn = 10 nghìn"],
            ["100,000", "10万 (じゅうまん)", "jūman", "10 vạn = 100 nghìn"],
            ["1,000,000", "100万 (ひゃくまん)", "hyakuman", "100 vạn = 1 triệu"],
            ["10,000,000", "1000万 (せんまん)", "senman", "1000 vạn = 10 triệu"],
            ["100,000,000", "1億 (いちおく)", "ichioku", "1 ức = 100 triệu"],
          ],
        },
        {
          type: "table",
          title: "小数と分数の読み方 — Cách đọc Số thập phân & Phân số",
          columns: ["Số / Phân số", "Tiếng Nhật (Kanji / Hiragana)", "Romaji", "Quy tắc đọc"],
          speakableColumns: [1],
          rows: [
            ["17.5", "17.5 (じゅうなな てん ご)", "jūnana ten go", "Dấu chấm thập phân đọc là 点 (てん)"],
            ["0.83", "0.83 (れいてん はちさん)", "reiten hachisan", "Số 0 đọc là れい, dấu chấm đọc là 点 (てん)"],
            ["1/2", "2分の1 (にぶんの いち)", "nibun no ichi", "Đọc Mẫu số trước: Mẫu số + 分の + Tử số"],
            ["3/4", "4分の3 (よんぶんの さん)", "yonbun no san", "Đọc Mẫu số trước: Mẫu số + 分の + Tử số"],
          ],
        },
        {
          type: "table",
          title: "階の数え方 — Bảng hướng dẫn chuẩn cách đếm tầng (1階 ～ 10階 & 何階)",
          columns: ["Số tầng", "Tiếng Nhật (Kanji / Hiragana)", "Romaji", "Lưu ý biến âm"],
          speakableColumns: [1],
          rows: [
            ["Tầng 1", "1階 (いっかい)", "ikkai", "Biến âm 促音 (Small tsu: いっかい)"],
            ["Tầng 2", "2階 (にかい)", "nikai", "Đọc bình thường (にかい)"],
            ["Tầng 3", "3階 (さんがい)", "sangai", "Biến âm 濁音 (Dakuon がい: さんがい)"],
            ["Tầng 4", "4階 (よんかい)", "yonkai", "Đọc bình thường (よんかい)"],
            ["Tầng 5", "5階 (ごかい)", "gokai", "Đọc bình thường (ごかい)"],
            ["Tầng 6", "6階 (ろっかい)", "rokkai", "Biến âm 促音 (Small tsu: ろっかい)"],
            ["Tầng 7", "7階 (ななかい)", "nanakai", "Đọc bình thường (ななかい)"],
            ["Tầng 8", "8階 (はっかい)", "hakkai", "Biến âm 促音 (Small tsu: はっかい)"],
            ["Tầng 9", "9階 (きゅうかい)", "kyūkai", "Đọc bình thường (きゅうかい)"],
            ["Tầng 10", "10階 (じゅっかい)", "jukkai", "Biến âm 促音 (Small tsu: じゅっかい)"],
            ["Tầng mấy?", "何階 (なんがい)", "nangai", "Biến âm 濁音 (Dakuon がい: なんがい)"],
          ],
        },
        {
          type: "table",
          ...
          rows: [
            ...
            ["Tầng 10 (10階)", "10階 (じゅっかい)", "Phòng triển lãm & Hội trường (画廊・ホール)"],
            ["Tầng 9 (9階)", "9階 (きゅうかい)", "Thành phố ăn uống & Rạp chiếu phim (飲食街・映画館)"],
            ["Tầng 8 (8階)", "8階 (はっかい)", "Nhà hàng & Phòng tổ chức sự kiện (レストラン・催し物会場)"],
            ["Tầng 7 (7階)", "7階 (ななかい)", "Đồng hồ, Kính mắt, Máy ảnh (時計・眼鏡・カメラ)"],
            ["Tầng 6 (6階)", "6階 (ろっかい)", "Dụng cụ thể thao & Đồ du lịch (スポーツ用品・旅行用品)"],
            ...
            ["Tầng 3 (3階)", "3階 (さんがい)", "Quần áo nam (紳士服)"],
      ...
      blocks: [
        {
          ...
          title: "Bài nghe trong sách giáo trình (Bài 3)",
