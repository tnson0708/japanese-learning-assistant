  ...
  sections: [
    {
      ...
      blocks: [
        ...
        {
          type: "vocab-group",
          heading: "Biểu hiện Thời gian chi tiết: Ngày, Tuần, Tháng, Năm, Sáng & Tối (時間表現)",
          items: [
            { jp: "おととい", meaning: "hôm kia, hai hôm trước" },
            { jp: "きのう", meaning: "hôm qua" },
            { jp: "きょう", meaning: "hôm nay" },
            { jp: "あした", meaning: "ngày mai" },
            { jp: "あさって", meaning: "ngày kia, ngày mốt" },
            { jp: "まいにち", kanji: "毎日", meaning: "hàng ngày, mỗi ngày" },
            {
              jp: "せんせんしゅう",
              kanji: "先々週",
              meaning: "tuần trước nữa (2 tuần trước / にしゅうかんまえ)",
            },
            { jp: "せんしゅう", kanji: "先週", meaning: "tuần trước" },
            { jp: "こんしゅう", kanji: "今週", meaning: "tuần này" },
            { jp: "らいしゅう", kanji: "来週", meaning: "tuần sau" },
            { jp: "さらいしゅう", kanji: "再来週", meaning: "tuần sau nữa" },
            { jp: "まいしゅう", kanji: "毎週", meaning: "hàng tuần, mỗi tuần" },
            {
              jp: "せんせんげつ",
              kanji: "先々月",
              meaning: "tháng trước nữa (2 tháng trước / にかげつまえ)",
            },
            { jp: "せんげつ", kanji: "先月", meaning: "tháng trước" },
            { jp: "こんげつ", kanji: "今月", meaning: "tháng này" },
            { jp: "らいげつ", kanji: "来月", meaning: "tháng sau" },
            { jp: "さらいげつ", kanji: "再来月", meaning: "tháng sau nữa" },
            { jp: "まいつき", kanji: "毎月", meaning: "hàng tháng, mỗi tháng" },
            {
              jp: "おととし",
              kanji: "一瞬間 / 一昨年",
              meaning: "năm kia, 2 năm trước",
            },
            { jp: "きょねん", kanji: "去年", meaning: "năm ngoái" },
            { jp: "ことし", kanji: "今年", meaning: "năm nay" },
            { jp: "らいねん", kanji: "来年", meaning: "sang năm, năm sau" },
            { jp: "さらいねん", kanji: "再来年", meaning: "năm sau nữa" },
            {
              jp: "まいとし / まいねん",
              kanji: "毎年",
              meaning: "hàng năm, mỗi năm",
            },
            { jp: "おとといの あさ", meaning: "sáng hôm kia" },
            { jp: "きのうの あさ", meaning: "sáng (hôm) qua" },
            { jp: "けさ", meaning: "sáng nay" },
            { jp: "あしたの あさ", meaning: "sáng (ngày) mai" },
            { jp: "あさっての あさ", meaning: "sáng ngày kia" },
            { jp: "まいあさ", kanji: "毎朝", meaning: "hàng sáng, mỗi sáng" },
            { jp: "おとといの ばん（よる）", meaning: "tối hôm kia" },
            { jp: "きのうの ばん（よる）", meaning: "tối (hôm) qua" },
            { jp: "こんばん（きょうの よる）", kanji: "今晩", meaning: "tối nay" },
            { jp: "あしたの ばん（よる）", meaning: "tối (ngày) mai" },
            { jp: "あさっての ばん（よる）", meaning: "tối ngày kia" },
    ...
    },
    {
      ...
      blocks: [
        {
          type: "table",
          title: "時間表現（日・週） — Bảng tra cứu thời gian theo Ngày & Tuần",
          columns: [
            "Đơn vị",
            "Quá khứ xa (-2)",
            "Quá khứ (-1)",
        ...
        {
          type: "table",
          title: "時間表現（月・年） — Bảng tra cứu thời gian theo Tháng & Năm",
          columns: [
            "Đơn vị",
            "Quá khứ xa (-2)",
            "Quá khứ (-1)",
        ...
        {
          type: "table",
          title: "時間表現（朝・晩） — Bảng tra cứu thời gian Buổi Sáng & Buổi Tối",
          columns: [
            "Thời điểm",
            "Quá khứ xa (-2)",
            "Quá khứ (-1)",
      ...
      blocks: [
        {
          ...
          title: "Bài nghe trong sách giáo trình (Bài 4)",
